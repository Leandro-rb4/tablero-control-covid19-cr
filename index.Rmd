---
title: "Estado del COVID-19 en Costa Rica (Por Leandro Rodríguez B.)"
output: 
...
icono_recuperados <- 'fa-heart'

icono_fallecidos <- ' fa-minus-circle'

icono_nuevos_positivos <- 'fa-plus-square'

icono_hospitalizados <- 'fa-hospital-o'
icono_salon <- 'fa-stethoscope'
icono_uci <- 'fa-bed'
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_posi, big.mark = ","), "", sep = " "), 
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_posi, big.mark = ","), "", sep = " "), 
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_posi, big.mark = ","), "", sep = " "), 
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_posi, big.mark = ","), "", sep = " "), 
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_posi, big.mark = ","), "", sep = " "), 
...
leaflet_cantones <- leaflet(sf_positivos_cantones_ultima_fecha) %>% 
  ...
  addPolygons(fillColor = ~paleta_naranja(positivos), stroke=T, fillOpacity = 1,
  ...
  addLegend("bottomright", pal = paleta_naranja, values = ~positivos,
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_acti, big.mark = ","), "", sep = " "), 
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_acti, big.mark = ","), "", sep = " "), 
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_acti, big.mark = ","), "", sep = " "), 
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_acti, big.mark = ","), "", sep = " "), 
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_acti, big.mark = ","), "", sep = " "), 
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$MUJ_RECUP, big.mark = ","), "", sep = " "), 
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$HOM_RECUP, big.mark = ","), "", sep = " "), 
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$ADUL_RECUP, big.mark = ","), "", sep = " "), 
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$AM_RECUP, big.mark = ","), "", sep = " "), 
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$MENOR_RECUP, big.mark = ","), "", sep = " "), 
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_fall, big.mark = ","), "", sep = " "), 
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_fall, big.mark = ","), "", sep = " "), 
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_fall, big.mark = ","), "", sep = " "), 
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_fall, big.mark = ","), "", sep = " "), 
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_fall, big.mark = ","), "", sep = " "), 
