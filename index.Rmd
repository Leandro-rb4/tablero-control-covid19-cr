...
color_positivos <- 'darkred'
color_activos <- 'red'
color_recuperados <- 'lightgreen'
color_fallecidos <- 'darkblue'
...
paleta_vino <- colorBin(palette = "Reds", 
...
leaflet_cantones <- leaflet(sf_positivos_cantones_ultima_fecha) %>% 
  ...
  addPolygons(fillColor = ~paleta_vino(positivos), stroke=T, fillOpacity = 1,
  ...
  addLegend("bottomright", pal = paleta_vino, values = ~positivos,
