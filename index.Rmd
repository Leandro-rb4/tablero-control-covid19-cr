...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_posi, big.mark = ","), "(+97)",  "(",
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_posi, big.mark = ","), "(+173)",  "(",
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_posi, big.mark = ","), "(+220)", "(",
...
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_posi, big.mark = ","), "(+9)",  "(",
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_posi, big.mark = ","), "(+40)", "(",
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_acti, big.mark = ","), "(+97)", "(",
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_acti, big.mark = ","), "(+173)", "(",
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_acti, big.mark = ","), "(+220)", "(",
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_acti, big.mark = ","), "(+9)", "(",
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_acti, big.mark = ","), "(+40)", "(",
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$MUJ_RECUP, big.mark = ","), "(+15)", "(",
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$HOM_RECUP, big.mark = ","), "(+58)", "(",
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$ADUL_RECUP, big.mark = ","), "(+31)", "(",
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$AM_RECUP, big.mark = ","),"(+0)", "(",
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$MENOR_RECUP, big.mark = ","), "(+11)", "(",
...
### Casos de mujeres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$muj_fall, big.mark = ","), "(+1)", "(",
...
### Casos de hombres
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$hom_fall, big.mark = ","), "(+0)","(",
...
### Casos de adultos
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$adul_fall, big.mark = ","),"(+0)","(",
...
### Casos de adultos mayores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$am_fall, big.mark = ","), "(+1)", "(",
...
### Casos de menores
```{r}
valueBox(value = paste(format(df_general_pais_ultima_fecha$menor_fall, big.mark = ","), "(+0)","(",
